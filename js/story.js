    ...
    choices: [
      {
        ...
        flavor: '你的话很冷。阿杰看着你，沉默了很久。第二天，他第一个到了训练室。有些话不用说出来。',
      },
      {
      ...
      {
        text: '"行。我理解。但走之前——把最后这周的训练打完。"',
        next: 'ch2_router_disband',
        effects: { '心态': -5, '人气': 5, '团队': -3 },
        flavor: '你尊重他的选择，但你也需要一个交代。阿杰沉默地点头。这最后一周，谁也不知道结局。',
      },
    ],
    on_enter: { '心态': -5 },
  },
